    ...
    return (
        <StaticLayout title="Terms & Conditions">
            ...
            <ul>
                ...
                <li>
                    <p><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in these Terms and Conditions) refers to careersha.</p>
                </li>
                <li>
                ...
                <li>
                    <p><strong>Website</strong> refers to careersha, accessible from <a href="https://www.careersha.com/" rel="external nofollow noopener" target="_blank">https://www.careersha.com/</a></p>
                </li>
                <li>
            ...
            <ul>
                <li>By email: support@careersha.com</li>
            </ul>
        </StaticLayout>
    );
};
