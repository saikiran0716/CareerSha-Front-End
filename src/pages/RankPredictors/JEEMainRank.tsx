    ...
    return (
        <div className="bg-[#F5F7FC] min-h-screen relative">
            <SEO 
                ...
                description="Predict your JEE Main 2026 rank based on your score. Get accurate estimates and college possibilities."
                keywords="JEE Main rank predictor, JEE Main 2026, rank estimator, engineering entrance"
            />
            ...
            <RankEstimator onAskAI={handleAskAI} defaultExam="JEE Main" />
        </div>
    );
};
