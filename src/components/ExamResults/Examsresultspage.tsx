...
const EXAM_CATEGORIES = [
    ...
    },
    {
        ...
        icon: GraduationCap,
        exams: [
            { name: 'JEE MAINS 2026', link: 'https://jeemain.nta.nic.in' },
            { name: 'JEE Advanced 2026', link: 'https://jeeadv.ac.in/' },
            { name: 'GATE 2026 (IIT Roorkee)', link: 'https://gate2026.iitr.ac.in/' },
            ...
            { name: 'TS EAPCET 2026', link: 'https://eapcet.tgche.ac.in/' },
            { name: 'AP EAPCET 2026', link: 'https://cets.apsche.ap.gov.in/' },
    ...
    },
    {
        ...
        icon: Stethoscope,
        exams: [
            { name: 'NEET UG 2026', link: 'https://neet.nta.nic.in' },
    ...
    },
    {
        ...
        exams: [
            ...
            { name: 'XAT 2026 Results', link: 'https://xatonline.in/' },
