...
const GlassLoader: React.FC = () => {
    return (
        <div className="fixed inset-0 z-[9999] flex flex-col items-center justify-center bg-white/10 dark:bg-slate-950/10 backdrop-blur-2xl overflow-hidden transition-all duration-700">
